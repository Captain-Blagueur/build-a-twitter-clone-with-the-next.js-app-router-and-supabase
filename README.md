...
9.  [Implement Protected Routes for authenticated users with Supabase Auth](/09-implement-protected-routes-for-authenticated-users-with-supabase-auth/README.md)
